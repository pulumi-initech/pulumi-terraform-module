...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("rdsmod");
			params.setVersion("6.10.0");
			params.setValue(Uint8Array.from(atob("ewogICJtb2R1bGUiOiAidGVycmFmb3JtLWF3cy1tb2R1bGVzL3Jkcy9hd3MiLAogICJ2ZXJzaW9uIjogIjYuMTAuMCIsCiAgInBhY2thZ2VOYW1lIjogInJkc21vZCIKfQ=="), c => c.charCodeAt(0)));
