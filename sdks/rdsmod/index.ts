...
pulumi.runtime.registerResourceModule("rdsmod", "index", _module)
pulumi.runtime.registerResourcePackage("rdsmod", {
    version: utilities.getVersion(),
    constructProvider: (name: string, type: string, urn: string): pulumi.ProviderResource => {
        if (type !== "pulumi:providers:rdsmod") {
