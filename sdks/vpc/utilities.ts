...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("vpc");
			params.setVersion("5.19.0");
			params.setValue(Uint8Array.from(atob("ewogICJtb2R1bGUiOiAidGVycmFmb3JtLWF3cy1tb2R1bGVzL3ZwYy9hd3MiLAogICJ2ZXJzaW9uIjogIjUuMTkuMCIsCiAgInBhY2thZ2VOYW1lIjogInZwYyIKfQ=="), c => c.charCodeAt(0)));
